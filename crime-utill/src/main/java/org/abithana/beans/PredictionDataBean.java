 ...
 */
public class PredictionDataBean implements Serializable{
    ...
    public PredictionDataBean(int year, int month, int day, int time, String dayOfWeek, String category, String pdDistrict,  int totalPopulation, int hispanic_Latino, int one_race_total, int white, int black_or_African_American, int american_Indian_and_Alaska_Native, int asian, int hawaiian, int other_Race, int two_or_More_Races) {
        this.year = year;
        this.month = month;
        this.day = day;
        Time = time;
